...
public class GameStateUnion extends org.apache.thrift.TUnion<GameStateUnion, GameStateUnion._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GameStateUnion");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GameStateUnion.class, metaDataMap);
  }

  public GameStateUnion() {
    super();
  }

  public GameStateUnion(_Fields setField, Object value) {
    super(setField, value);
  }

  public GameStateUnion(GameStateUnion other) {
    super(other);
  }
  public GameStateUnion deepCopy() {
    return new GameStateUnion(this);
  }

  public static GameStateUnion ticTacToeGameState(org.garethaye.minimax.generated.TicTacToeGameState value) {
    GameStateUnion x = new GameStateUnion();
    x.setTicTacToeGameState(value);
    return x;
  }

  public static GameStateUnion connectFourGameState(org.garethaye.minimax.generated.ConnectFourGameState value) {
    GameStateUnion x = new GameStateUnion();
  ...
  public boolean equals(Object other) {
    if (other instanceof GameStateUnion) {
      return equals((GameStateUnion)other);
    } else {
      return false;
    }
  }

  public boolean equals(GameStateUnion other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(GameStateUnion other) {
