 ...
 */
public class ConnectFourGameState implements org.apache.thrift.TBase<ConnectFourGameState, ConnectFourGameState._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ConnectFourGameState");
  ...
  static {
    schemes.put(StandardScheme.class, new ConnectFourGameStateStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ConnectFourGameStateTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ConnectFourGameState.class, metaDataMap);
  }
   ...
   */
  public ConnectFourGameState(ConnectFourGameState other) {
  ...
  public ConnectFourGameState deepCopy() {
  ...
  public ConnectFourGameState setActivePlayer(int activePlayer) {
    this.activePlayer = activePlayer;
    setActivePlayerIsSet(true);
    return this;
  }
  ...
  public ConnectFourGameState setInactivePlayer(int inactivePlayer) {
    this.inactivePlayer = inactivePlayer;
    setInactivePlayerIsSet(true);
    return this;
  }
  ...
  public ConnectFourGameState setBoard(List<List<Integer>> board) {
    this.board = board;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ConnectFourGameState)
      return this.equals((ConnectFourGameState)that);
    return false;
  }

  public boolean equals(ConnectFourGameState that) {
    if (that == null)
      return false;
  ...
  public int compareTo(ConnectFourGameState other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ConnectFourGameState typedOther = (ConnectFourGameState)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ConnectFourGameState(");
    boolean first = true;
  ...
  private static class ConnectFourGameStateStandardSchemeFactory implements SchemeFactory {
    public ConnectFourGameStateStandardScheme getScheme() {
      return new ConnectFourGameStateStandardScheme();
    }
  }

  private static class ConnectFourGameStateStandardScheme extends StandardScheme<ConnectFourGameState> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ConnectFourGameState struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ConnectFourGameState struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ConnectFourGameStateTupleSchemeFactory implements SchemeFactory {
    public ConnectFourGameStateTupleScheme getScheme() {
      return new ConnectFourGameStateTupleScheme();
    }
  }

  private static class ConnectFourGameStateTupleScheme extends TupleScheme<ConnectFourGameState> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ConnectFourGameState struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ConnectFourGameState struct) throws org.apache.thrift.TException {
